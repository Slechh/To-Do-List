  ...
  return (
    <UiModal className="min-h-50" isModalOpen={isOpen}>
      ...
      <div className="mt-auto flex justify-between text-lg font-medium h-9.5">
        <button
          onClick={onClose}
          className="flex items-center text-purple border-[1.5px] border-purple px-5 py-0.75 rounded-md hover:bg-purple/40 hover:text-white transition-colors duration-300"
        >
          CANCEL
        </button>
